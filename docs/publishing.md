...
4. Verify the release and **catalog description** clearly state that private/direct Whispers are excluded from collection/storage and that upgrades purge any legacy Whisper rows from the addon database.
